...
public class GUISettings {
    ...
    public static final Color STEPS_AREA_COLOR = new Color(245, 245, 245);
    ...
    public static final Color MOUSE_ENTERED_BACKGROUND_COLOR = new Color(180, 180, 180);
    public static final Color MOUSE_ENTERED_BORDER_COLOR = new Color(150, 150, 150);
